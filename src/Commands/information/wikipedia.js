...
module.exports = class extends Command {
    constructor(...args) {
        super(...args, {
            ...
            category: "info",
            description: "Shows answers from Wikipedia website.",
            usage: "[query]",
        ...
        if (!search.results.length) {
            return m.edit({
                embed: {
                    color: "GREEN",
                    title: "What was that? 📚🤓",
                    description: "Wikipedia found **0** results of what you've searched for.",
                    footer: {
        ...
        try {
            ...
            if (description.length > 8192) {
                const FirstEmbed = new MessageEmbed()
                    ...
                    .setColor("GREEN")
                    .setDescription(`${description.substring(0, 1950)}...\nArticle is too long we're sorry... Click [**here**](${result.raw.fullurl}) to read out more!`);
